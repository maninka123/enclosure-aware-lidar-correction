...
The new package has no runtime imports or file dependencies on these historical sources. Exact paper-equation mapping, all legacy robustness plots, lookup-table benchmarks, external solver validation, and instrument calibration remain separate follow-up work.
